...
mkdir -p "$output"
for file in configuration.js content.js editor.css editor.html editor.js options.css options.html options.js readiness.html readiness.js service-worker.js source-identity-contract.js source-identity.js zip-core.min.js zip-js.LICENSE; do
