...
mkdir -p "$output"
for file in cfb.LICENSE cfb.min.js configuration.js content.js hosted-editor.css hosted-editor.html hosted-editor.js options.css options.html options.js readiness.html readiness.js service-worker.js source-identity-contract.js source-identity.js zip-core.min.js zip-js.LICENSE; do
